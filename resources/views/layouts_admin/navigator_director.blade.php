<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Obull Direction</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/tables.html">
            ...
            <span class="nav-link-text ms-1">Enseignats</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="{{ route('eleves') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ route('options') }}">
            ...
            <span class="nav-link-text ms-1">Option</span>
          </a>
        </li>
    ...
    <div class="sidenav-footer mx-3 ">
      ...
      <a class="btn bg-gradient-info mt-3 w-100" href="#">Deconnexion</a>
    </div>
  </aside>
